...
def terminal_tool(
    ...
    try:
        ...
        # Route remote editor workspaces through ACP only after the common
        # lifecycle/workdir/self-repo and approval guards have passed.
        try:
        ...
        if _acp_terminal_bridge is not None and _acp_terminal_bridge.acp_terminal_active():
            ...
            if acp_result is not None:
                if verdict.note:
                    acp_result["approval_note"] = verdict.note

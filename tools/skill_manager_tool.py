...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    resolver did not follow directory symlinks. Accept both bare directory
    names and categorized relative paths (``mlops/axolotl``), plus the
    ``category:skill`` local fallback used by ``skill_view``.
    """

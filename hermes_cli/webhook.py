...
def _normalize_action(action: str) -> str | None:
    ...
    return "" if not action else _ACTION_ALIASES.get(action)
...
def _cmd_subscribe(args):
    ...
    if action is None:
        print("Error: Unknown --action. Supported deterministic actions: kanban_intake_links (aliases: intake-links, kanban-intake-links).")
        return

...
def _prepare_agent_startup(args) -> None:
    ...
    try:
        try:
            if _is_tui_chat_launch(args):
                # The spawned tui_gateway backend owns plugin discovery. Avoid
                # doing the same work in the short-lived Node launcher first.
                pass
            elif _preserve_protocol_stdout:
...
def main():
    ...
    update_maintenance_parser.set_defaults(func=_self().cmd_update_maintenance)

...
export const ko: Translations = {
  ...
  kanban: {
    ...
    logAt: ")",
    degradedBoard: "Board '{name}' is degraded",
    degradedReason: "Reason: {reason}",
    degradedBackupPath: "Corrupt file backed up to:",
    switchToHealthyBoard: "Switch to a healthy board",
    viewRepairGuidance: "View repair guidance",
    boardHealthHealthy: "healthy",
    boardHealthDegraded: "degraded",

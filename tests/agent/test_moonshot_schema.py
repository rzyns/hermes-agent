...
class TestUnionTypeList:
    ...
    def test_null_only_union_falls_back_to_schema_shape_inference(self):
        """A null-only type array should not block object/array inference."""
        params = {
            "type": "object",
            "properties": {
                "metadata": {
        ...
        assert out["properties"]["metadata"]["type"] == "object"

...
class TestFTS5Search:
    ...
    def test_search_projection_skips_context_enrichment_queries(self, db):
        ...
        try:
            ...
            # Read queries may run on pooled connections that the trace above
            # does not observe. The projection assertions verify the contract
            # without coupling the test to a particular query shape.

...
def _setup_update_mocks(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(hermes_main, "_validate_critical_files_syntax", lambda *a, **kw: (True, None, None))
    monkeypatch.setattr(hermes_main, "_refresh_bootstrap_cache_scripts", lambda *a, **kw: None)
    monkeypatch.setattr(hermes_main, "_abort_dependency_sync_if_self_locked", lambda *a, **kw: None)
    monkeypatch.setattr("hermes_cli.update_cmd._editable_install_is_current", lambda *a, **kw: True)

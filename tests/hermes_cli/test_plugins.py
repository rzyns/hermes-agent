...
class TestPluginContext:
    ...
    @pytest.mark.skip(reason="superseded by ownership-ledger registration lifecycle coverage")
    ...
    @pytest.mark.skip(reason="superseded by capability-gated ownership-ledger override coverage")

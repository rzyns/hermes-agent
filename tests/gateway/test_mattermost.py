...
class TestMattermostConfigLoading:
    ...
    def test_apply_yaml_config_sets_reactions_env(self, monkeypatch):
        ...
        assert _apply_yaml_config({}, {"reactions": False}) == {"reactions": False}
...
class TestMultiplexProfileScope:
    ...
    def test_scoped_reactions_do_not_borrow_default_profile_env(
        self, multiplex_scope, monkeypatch
    ):
        monkeypatch.setenv("MATTERMOST_REACTIONS", "true")
        multiplex_scope({"MATTERMOST_REACTIONS": "false"})

...
def classify_api_error(
    ...
    *,
    ...
    # A broken certificate chain is deterministic for the host. Check this
    # before generic message patterns because Node/undici prefixes the useful
    # certificate detail with the otherwise-transient phrase "fetch failed".

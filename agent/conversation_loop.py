...
def run_conversation(
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        # Start cache planning from the request-local selection.  This preserves
        # plugin schema filtering while still allowing native prompt caching to
        # decorate a copy of the selected tool list.
        tools_for_api = tools_for_request
        ...
        request_pressure_tokens = approx_tokens + (
            _estimate_tools_tokens_rough(tools_for_request)

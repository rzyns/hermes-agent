...
def run_conversation(
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        # separate field. Add the request-local tools back for compression
        # decisions so long tool-heavy turns do not creep up to the context
        # ceiling and leave no room for the model's final answer.

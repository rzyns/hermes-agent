...
KANBAN_GUIDANCE = (
    ...
    "metadata=...)`. `summary` is 1–3 concrete sentences. `metadata` is "
    "machine-readable facts (`{changed_files: [...], tests_run: N, commit: "
    "<sha>}` or `no_commit_reason`). Never put secrets/tokens/raw PII there. "
    ...
    "reviewing-then-completing is more honest than auto-completing.\n"

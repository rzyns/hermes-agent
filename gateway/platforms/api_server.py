...
class APIServerAdapter(BasePlatformAdapter):
    ...
    def _session_response(session: Dict[str, Any]) -> Dict[str, Any]:
        ...
        safe_keys = (
            "id", "source", "user_id", "model", "title", "title_source",
            "title_updated_at", "title_revision_count", "started_at", "ended_at",
    ...
    def _make_run_event_callback(self, run_id: str, loop: "asyncio.AbstractEventLoop"):
        ...
        def _push(event: Dict[str, Any]) -> None:
            ...
            # Preserve the legacy per-run queue for in-process consumers and
            # older callers while the replay-capable producer owns public SSE.
        ...
        async def _run_and_close():
            try:
                ...
                # block below never fires — issue #15561).
                    ...
                    _emit_event_if_active(completed_event)
                    self._set_run_status(
                        run_id,
                        "completed",
                        output=final_response,

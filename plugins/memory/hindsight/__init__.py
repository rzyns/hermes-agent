...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def _new_embedded_client(self):
        ...
        reasoning_effort = cfg.get("llm_reasoning_effort") or os.environ.get(
            "HINDSIGHT_API_LLM_REASONING_EFFORT", ""
        )
        if reasoning_effort and hasattr(client, "config"):
            client.config["HINDSIGHT_API_LLM_REASONING_EFFORT"] = str(reasoning_effort)
        return client
